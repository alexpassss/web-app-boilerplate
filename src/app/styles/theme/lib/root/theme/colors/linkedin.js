...
const linkedin = {
  darken1: Color(colors.linkedin)
    .darken(blending.darken1.basic)
    .hex(),
  default: colors.linkedin,
  lighten1: Color(colors.linkedin)
    .alpha(blending.lighten1.basic)
    .rgb()
    .string(),
  lighten2: Color(colors.linkedin)
    .alpha(blending.lighten2.basic)
    .rgb()
    .string(),
  lighten3: Color(colors.linkedin)
    .alpha(blending.lighten3.basic)
    .rgb()
    .string(),
  lighten4: Color(colors.linkedin)
    .alpha(blending.lighten4.basic)
    .rgb()
    .string(),
  lighten5: Color(colors.linkedin)
    .alpha(blending.lighten5.basic)
    .rgb()
    .string(),
  lighten6: Color(colors.linkedin)
